...
export const MainMenu = ({items}) => {
  return (
    <div className=" bg-neutral-50 px-5 h-[64px] sticky top-0 z-20 flex">
        ...
        {(items || []).map((item) => (
          ...
          >
            ...
            {!!item.subMenuItems?.length && (
              <div className="group-hover:block hidden bg-neutral-50 text-right absolute right-0 top-full -mt-3">
